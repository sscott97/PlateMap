...
class ElisaApp:
    def __init__(self, root):
        ...
        self.center_window(self.root, 300, 100)
    ...
    def create_plate_inputs(self):
        ...
        for i in range(self.num_plates_var.get()):
            ...
            # Center the input frame relative to root
            frame.update_idletasks()
            self.center_widget(frame)
            self.text_boxes.append(text)

    def center_widget(self, widget):
        # Center a frame widget over root
    ...
    def generate(self):
        ...
        self.center_window(win, 800, 300)
